...
- Test Display submenu contains "Test Thresholds" (preview color thresholds at 10/40/75/85/95%), "Test Errors" (simulate keychain, network, auth, rate-limit, server, decoding errors), "Test Weekly" (preview weekly display at 40/70/95/25%), and "Test Sonnet" (preview sonnet display at 40/70/95/25%) nested submenus; all prepend "TEST: " to the menu bar text while active
